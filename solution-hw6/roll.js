...
const qty1P = new Pack("1");
const qty3P = new Pack("3");
const qty6P = new Pack("5");
const qty12P = new Pack("10");
const packP = [qty1P, qty3P, qty6P, qty12P];
